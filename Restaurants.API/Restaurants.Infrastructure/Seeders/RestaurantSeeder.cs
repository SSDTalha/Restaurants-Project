...
//                        }
//                    },
//                    CompanyId = "1001" // Assigning a specific CompanyId    //CompanyId = random.Next(1001, 1100) // Random CompanyId between 1001 and 1100 iss se random comapny idd assign ho jaye gi
//                },
//                new Restaurant
//                {
//                    Name = "Desi Delight",
...
//                        }
//                    },
//                    CompanyId = "1002" // Assigning a different CompanyId
//                },
//                new Restaurant
//                {
//                    Name = "Burger Hub",
...
//                        }
//                    },
//                    CompanyId = "1003" // Assigning a different CompanyId
//                },
//                new Restaurant
//                {
//                    Name = "Green Bowl",
...
//                        }
//                    },
//                    CompanyId = "1004" // Assigning a different CompanyId
//                },
//                new Restaurant
//                {
//                    Name = "Sweet Tooth",
...
//                        }
//                    },
//                    CompanyId = "1005" // Assigning a different CompanyId
//                }
//            };
...
namespace Restaurants.Infrastructure.Seeders
{
    internal class RestaurantSeeder(RestaurantsDbContext dbContext, IConfiguration configuration) : IRestaurantSeeder
    {
        public async Task Seed()
        {
            try
            {
                var predefinedRestaurants = GetRestaurants();

                foreach (var restaurant in predefinedRestaurants)
                {
                    // Duplicate check by name (you can also check by ContactEmail or CompanyId)
                    bool exists = await dbContext.Restaurants.AnyAsync(r => r.Name == restaurant.Name);
